...
def test_clear_locations(weather_model, sample_weather_response, mocker):
    ...
    """
    mocker.patch("weather.weather.models.weatherData_model.get_current_weather", return_value=sample_weather_response)
...
def test_update_weather_data(weather_model, sample_weather_response, mocker):
    ...
    mocker.patch("weather.weather.models.weatherData_model.get_current_weather", return_value=updated_data)
